...
const Notification = () => {
  ...
  return (
    <div className={close ? "hidden" : "text-sm lg:text-base font-light tracking-wide flex justify-between items-center p-4 border-b-[1.5px] border-gray-200"} >
      ...
      <p className='text-center  font-bold'><Link target="_blank" className='text-green-700' href='https://wa.me/212656739688'>06 56 73 96 88</Link> :  للطلب أو الإستشارة إتصل على الرقم  </p>
      </div>
